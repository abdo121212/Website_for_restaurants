...
const HeadlineCards = () => {
  return (
    <div className='max-w-[1640px] mx-auto p-4 py-12 grid sm:grid-cols-1 md:grid-cols-3 gap-6'>
      {/* Card */}
      <div className='rounded-xl relative hover:scale-105 duration-300   '>
        ...
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          ...
          <button className='border-white rounded-lg px-2 bg-white text-black mx-2 absolute bottom-4'>Order Now</button>
        </div >
        <img
